...
**DATASOC** es una iniciativa de Ciencia de Datos de la Facultad de Ciencias Sociales que busca **posicionar a la Facultad como un referente nacional en el desarrollo de las ciencias de datos sociales**, articulando investigación, formación, gestión e impacto  a través de las siguientes líneas de acción:
...
# Ciencia de Datos en Investigación (CINDAI)
...
Plataforma de visualización pública con datos sintéticos sobre proyectos de investigación en la Facultad. [Maqueta](https://dip-facso.shinyapps.io/datos-abiertos-CINDAI/#inicio){target="_blank}
