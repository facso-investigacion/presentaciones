...
proyectos <- read_excel("peticion-vice/input/postulaciones-regular.xlsx") %>% clean_names()
...
# 7. Guardar ----
saveRDS(postulaciones, "peticion-vice/input/postulaciones-2018-2025.rds")

# Correr esto con nueva base de Acad, por si sale bien Sembler
